...
function Info:init()
  ...
  self.martenitsaLogo = love.graphics.newImage('asset/martenitsa-logo.png')
end
...
function Info:draw()
  ...
  elseif self.level == 8 then
    ...
    love.graphics.draw(self.martenitsaLogo, getCenteredHorizontalPosition(375), baseY + namesCount*namesHeight + 1250)
  end
  ...
  elseif self.level == 8 then
    ...
    love.graphics.printf("The levels are designed using", getCenteredHorizontalPosition(width), baseY + namesCount*namesHeight + 540, width, "center")
    love.graphics.printf("And the game is written in", getCenteredHorizontalPosition(width), baseY + namesCount*namesHeight + 680, width, "center")
    love.graphics.printf("with", getCenteredHorizontalPosition(width), baseY + namesCount*namesHeight + 820, width, "center")
  end
