...
function Info:draw()
  ...
  if self.level == 1 then
    ...
    love.graphics.printf(levelText, 300, 120, 600, "left")
  ...
  elseif self.level == 5 then
    ...
    love.graphics.printf(levelText, 300, 80, 600, "left")
  ...
  elseif self.level == 7 then
    ...
    love.graphics.printf(levelText, 300, 70, 680, "left")
  elseif self.level == 8 then
    local levelText = "Credits"
    love.graphics.printf(levelText, 300, 70, 680, "center")
  end
